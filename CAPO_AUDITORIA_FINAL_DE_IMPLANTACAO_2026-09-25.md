...
A responsável esclareceu em 26/09/2026 que espera que o botão **Perfil** permita mudar a visão de trabalho quando a mesma conta acumular funções já autorizadas. Clínico Geral e Coordenador foi apenas um exemplo, não um limite da regra. A seleção deve respeitar as permissões estabelecidas, sem criar papéis ou ampliar acesso.
